...
<a href="http://www.canada.ca/fr/index.html"><object type="image/svg+xml" tabindex="-1" data="./distro/4.0.9/assets/sig-blk-fr.svg"></object><span class="wb-inv"> Gouvernement du Canada</span></a>
</div>
      ...
      <section id="wb-srch" class="col-xs-6 text-right visible-md visible-lg">
		...
		var autoCompletionOptions = { 'validLanguages' : 'fr', };
		...
		google.setOnLoadCallback( function() {setTimeout( function(){google.search.CustomSearchControl.attachAutoCompletionWithOptions( '008724028898028201144:knjjdikrhq0', document.getElementById( 'wb-srch-q-imprt' ), 'cse-search-box',autoCompletionOptions );}, 2000);});
          ...
          <div class="form-group">
            <label for="wb-srch-q" class="wb-inv">Rechercher dans le site Web</label>
			...
			<input type="hidden" name="cdn" value="hcans" />
  ...
  <nav role="navigation" id="wb-sm" class="wb-menu visible-md visible-lg" data-trgt="mb-pnl" data-ajax-fetch="./distro/4.0.9/ajax/sitemenu-fr.html" typeof="SiteNavigationElement">
    <h2 class="wb-inv">Menu du site</h2>
    <div class="container visible-md visible-lg nvbar">
      <div class="row">
        <ul class="list-inline menu">
          <li><a href="http://www.canada.ca/fr/services/emplois/index.html">Emplois</a></li>
          ...
          <li><a href="http://www.canada.ca/fr/services/sante/index.html">Santé</a></li>
          <li><a href="http://www.canada.ca/fr/services/impots/index.html">Impôts</a></li>
          <li><a href="http://canadiensensante.gc.ca/index-fra.php">Autres services</a></li>
        </ul>
      </div>
    </div>
  </nav>
